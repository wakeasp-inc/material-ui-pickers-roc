...
Version `v3` for @wakeasp_tw/material-ui-roc-pickers is coming with a whole bunch of breaking changes. This is a guide of how-to update :)
<Ad />

#### ⬇️ Install

First of all, you need to install the new package, because the project is transferred to mui-org!
Please also note, that **v3** of `@wakeasp_tw/material-ui-roc-pickers` relies on **v4** of `@material-ui/core`

```
npm i @wakeasp_tw/material-ui-roc-pickers @material-ui/core@latest

yarn add @wakeasp_tw/material-ui-roc-pickers @material-ui/core@latest
```
...
```diff
- import { InlineDatePicker } from '@wakeasp_tw/material-ui-roc-pickers'
+ import { DatePicker } from '@wakeasp_tw/material-ui-roc-pickers'
